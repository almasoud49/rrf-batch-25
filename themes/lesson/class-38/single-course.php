                    ...
                    <?php if (!empty($requirements)): ?>
                      <ul>
                        <?php foreach ($requirements as $requirement) : ?>
                          <li><i class="fas fa-circle bullet-icon"></i><?php echo esc_html($requirement); ?></li>
                        <?php endforeach; ?>
              ...
              <div id="instructor" class="tab-pane">
                <div class="instructor-profile">
                  ...
                  <div class="instructor-details">
                    ...
                    <div class="stats">
                      <div class="stat">
                        <div class="value"><?php echo number_format($enrolled_students); ?></div>
                        <div class="label">Students</div>
                      </div>
                      <div class="stat">
                        <div class="value"><?php echo count_user_posts($instructor_id, 'course'); ?></div>
            ...
            <?php if (!empty($target_audience)): ?>
              <ul>
                <?php foreach ($target_audience as $audience) : ?>
                  ...
                  <li><i class="fas fa-check check-icon"></i><?php echo esc_html($audience); ?></li>
