...
// Custom Post Type for Courses Start Here
include_once get_template_directory() . '/inc/custom-post-types.php';

// Custom Post Type for Testimonials Start Here

function lessonlms_register_register(){
...
add_action('init','lessonlms_register_register');
...
function lessonlms_testimonial_callback($post){
  ...
  ?>
  <p>
    <label><strong>Designation / Course Name:</strong></label>
