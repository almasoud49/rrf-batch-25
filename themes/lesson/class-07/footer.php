            ...
            <div class="footer-nav address">
                ...
                <div class="address-details location">
                    <a href="https://maps.app.goo.gl/5QJbeQc3kLpr9bX49">
                        <span><strong>Location:</strong> <?php echo get_theme_mod('footer_location'); ?></span>
                    </a>
                </div>
                ...
                <div class="address-details email">
                    <a href="mailto:email@gmail.com">
                        <span><strong>Email:</strong> <?php echo get_theme_mod('footer_email'); ?></span>
                    </a>
                </div>
                ...
                <div class="address-details phone">
                    <a href="tel:+0001234567890">
                        <span><strong>Phone:</strong> <?php echo get_theme_mod('footer_phone'); ?></span>
                    </a>
                </div>
            </div>
        </div>
