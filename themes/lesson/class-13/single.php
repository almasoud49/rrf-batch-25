                ...
                <?php if (have_posts()) : ?>
                    <?php while (have_posts()) : the_post(); ?>
                                        ...
                                        <div class="comment" id="comment-<?php echo $comment->comment_ID?>">
                                            ...
                                            <div class="comment-content">
                                                <div class="comment-meta">
                                                    ...
                                                    <span class="comment-date"><?php echo human_time_diff(strtotime($comment->comment_date),current_time('timestamp')); ?> ago</span>
                                                </div>
                        ...
                        <div class="comment-form">
                            ...
                            comment_form(array(
                                'fields' =>  array(
                                    'author' => '<div class="form-row"><div class="form-group"><input type="text" id="author" name="author" placeholder="Name" required></div>',
                                    'email' => '<div class="form-group"><input type="email" id="email" name="email" placeholder="Email" required></div></div>'
                                ),
